...
CHANGE_IN_PRICE_MIN = Decimal(
    str(parsed_config["trading_options"]["CHANGE_IN_PRICE_MIN"])
)
CHANGE_IN_PRICE_MAX = Decimal(
    str(parsed_config["trading_options"]["CHANGE_IN_PRICE_MAX"])
)
...
TRAILING_STOP_LOSS = Decimal(
    str(parsed_config["trading_options"]["TRAILING_STOP_LOSS"])
)
TRAILING_TAKE_PROFIT = Decimal(
    str(parsed_config["trading_options"]["TRAILING_TAKE_PROFIT"])
)
...
DYNAMIC_WIN_LOSS_UP = Decimal(
    str(parsed_config["trading_options"]["DYNAMIC_WIN_LOSS_UP"])
)
DYNAMIC_WIN_LOSS_DOWN = Decimal(
    str(parsed_config["trading_options"]["DYNAMIC_WIN_LOSS_DOWN"])
)
DYNAMIC_CHANGE_IN_PRICE = Decimal(
    str(parsed_config["trading_options"]["DYNAMIC_CHANGE_IN_PRICE"])
)
...
HOLDING_PRICE_THRESHOLD = Decimal(
    str(parsed_config["trading_options"]["HOLDING_PRICE_THRESHOLD"])
)
TRAILING_BUY_THRESHOLD = Decimal(
    str(parsed_config["trading_options"]["TRAILING_BUY_THRESHOLD"])
)
