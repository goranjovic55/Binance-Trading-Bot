...
def session(type: str) -> None:
    ...
    if type == "calc":
        ...
        session_struct["investment_value"] = (
            Decimal(session_struct["market_price"]) * session_struct["NEW_BALANCE"]
        )
        session_struct["investment_value_gain"] = Decimal(
        ...
        if (
            ...
            session_struct["profit_to_trade_ratio"] = Decimal(
