...
def report(type, reportline):
    ...
    if type == 'detailed':
        print(
            ...
            , f"Time To Min Holding Price: {txcolors.DEFAULT}"
              f"{trading_struct['time_to_min_holding_price']:.2f}\n"
            , f"Time To Max Holding Price: {txcolors.DEFAULT}"
              f"{trading_struct['time_to_max_holding_price']:.2f}\n"
